		...
		<div class="container">
			  ...
			  <p>Segera lakukan pembayaran sesuai dengan yang ada pada data dibawah ini</p>
				...
				<div class="panel-body">
		          ...
		          <b>Catatan : </b>
		          <p>Jika sudah melakukan pembayaran, silahkan lakukan konfirmasi pembayaran pada menu Profil</p><a href="profil.php" class="btn btn-primary">Konfirmasi Pembayaran</a>
		        </div>
