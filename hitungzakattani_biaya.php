...
?>
  ...
  <h2 class="my-3">Hitung Zakat Pertanian Makanan Pokok Dengan Pengairan Pribadi</h2>
  <ol>
  ...
  <div class="well">
    <form method="post" action="">
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" placeholder="Minimal 520 Kg" name="hasilpanen" value="<?= $hasilpanen ?>">
