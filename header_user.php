...
<head>
  ...
  <title>LAZNAS Dewan Da'wah Lampung</title>
          ...
          <div class="row">
            <div class="col-xl-9 col-md-9 col-lg-9">
              <div class="header-contact">
                <a href="#"><i class="fas fa-phone"></i> 08117904020</a>
                <a href="#"><i class="fas fa-envelope"></i> lazisddlampung@gmail.com</a>
                <a href="#"><i class="fas fa-map-marker"></i> Jl. Sutan Jamil No.28, Gedong Meneng, Bandar Lampung</a>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-xl-2 col-lg-2">
              <div class="logo-img">
                <a href="index.php">
                  <img style="width: 32;" height="50" src="img/logo/logo.png" alt="">
                </a>
              </div>
            </div>
              ...
              <div class="main-menu d-none d-lg-block">
                <nav>
                  <ul id="navigation">
                    ...
                    <li><a href="#">Informasi Zakat <i class="fas fa-angle-down"></i></a>
                      <ul class="submenu">
